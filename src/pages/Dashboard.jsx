    ...
    <>
     <div className=' bg-midnight_blue w-full h-full text-white p-3.5'>
        <header className='flex items-center justify-between'>
          <div className="title text-pastel_blue text-2xl font-medium">Dashboard</div>
          <input type="search" name="" id="" className='rounded-full w-2/5 h-10 text-xs bg-transparent border-1 p-3' placeholder='Search for best Lectures, Tutorials, Courses...'/>
